...
/***/ function(module, exports, __webpack_require__) {
	...
	var Widgets = React.createClass({
	  ...
	  items: [{ title: "Clock", content: "I tell time" }, { title: "Weather", content: "I'm cold today" }],
	
	  render: function () {
	    return React.createElement(Tabs, { items: this.items });
	  }
	});
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        this.props.items.map(function (m, i) {
	          return React.createElement(Header, { title: m.title, key: i, index: i, focused: self.state.index, onClick: self.clicked.bind(self, i) });
	        })
	      ),
	      React.createElement(
	        'article',
	        null,
	        this.props.items[this.state.index].content
	      )
	    );
	  }
	});
	...
	var Weather = React.createClass({
	  ...
	  getWeather: function (lat, lon) {
	    ...
	    xhr.onerror = () => {
	      this.setState({ weather: "error sending" });
	    };
	    xhr.send();
	  },
	...
	var NY1 = React.createClass({
	  ...
	  render: () => React.createElement('div', {}, React.createElement(Clock, null), React.createElement(Weather, null))
	});
	...
	document.addEventListener("DOMContentLoaded", function () {
	  ReactDOM.render(React.createElement(Widgets, null), document.getElementById('tabs'));
	  ReactDOM.render(React.createElement(NY1, null), document.getElementById('weather-clock'));
	  ReactDOM.render(React.createElement(Autocomplete, { words: words }), document.getElementById('autocomplete'));
	});
